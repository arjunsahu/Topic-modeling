...
echo $table_name= $_POST["table_name"]?: 'ridd_savvy';//ridd_savvy
...
<form method="post" action="">
  <div class="top  b-b" style="background-color:#F0F0F0">
   <div class="box" style=" margin-bottom: 0rem;">
		...
		<div class="row">
		    <div class="col-md-8">
          <h2>Section B2 - FeedBack On the  Vehicle Ridden</h2>
...
while($r = mysql_fetch_array($word)) {
			...
			<!-- Section B -->
			<div class="col-md-12 text-center" style="padding-bottom: 15px;"> 
					<span  class="btn btn-sm btn-outline rounded b-accent">Section B2 </span> 
    ...
    <option value="problem_dislike">Aspects Disliked Problem</option>
         ...
         <option selected disabled>Select Vehicle</option>
			...
			<!-- Section B -->
			<div class="col-md-12 text-center" style="padding-bottom: 15px;"> 
					<span  class="btn btn-sm btn-outline rounded b-accent">Section B2 rank1 for tvs Entorq </span> 
...
$q_add="and vichel in (1) and r_name like '%ENT%' and reason_choosing_ranked_1_vname like '%ENT%' and expo_name like '%ENT%' ";
$concept='';
}
...
foreach ($analysis as $value) {  $body[] = "$value REGEXP 'body|heav|wei'  " ;}
