...
if (preg_match('/Entor/',$concept)){$correct=4;}else {$correct=0;}
...
<form method="post" action="">
  <div class="top  b-b" style="background-color:#F0F0F0">
   <div class="box" style=" margin-bottom: 0rem;">
		...
		<div class="row">
		    <div class="col-md-8">
          <h2>Section B03 - FeedBack On the  Vehicle Exposed</h2>
...
");
  ...
  echo "<script>console.log( 'Total Review: " . $correct . "' );</script>";
