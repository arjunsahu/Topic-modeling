...
$keywords=array('first_impression');

if (in_array('first_impression', $analysis)) {$divide=4;echo $divide;}


else {$divide=4;echo $divide;}
...
<form method="post" action="">
  <div class="top  b-b" style="background-color:#F0F0F0">
   <div class="box" style=" margin-bottom: 0rem;">
		...
		<div class="row">
		    <div class="col-md-8">
          <h2>Section BO1 - FeedBack On the  Vehicle first Impression </h2>
...
while($r = mysql_fetch_array($word)) {
			...
			<div class="col-sm-4">
			<small class="label label-default label-as-badge">Select Intender Vehicle</small>
			<div class="form-group row">
              ...
              <div class="col-sm-10">
                <select class="form-control c-select" name="intender">
                  ...
                  <option value="">All</option>    
                  <?php 
				$word = mysql_query("select distinct(brand_intended) from expo_savvy  ");

while($r = mysql_fetch_array($word)) {
	
                 echo" <option value='".$r["brand_intended"]."'>".$r["brand_intended"]."</option>";
}
				  ?>
                </select>
              </div>
			  ...
			  <small class="label label-default label-as-badge">Select exposed/ridden</small>
                <select class="form-control c-select" name="table_name" >
                 ...
                 <option selected disabled>exposed/ridden</option>
                  ...
                  <option value="expo_savvy">Exposed</option>
...
while($r = mysql_fetch_array($word)) {
			...
			<!-- Section F -->
			<div class="col-md-12 text-center" style="padding-bottom: 15px;"> 
					<span  class="btn btn-sm btn-outline rounded b-accent">Section BO1 </span> 
	 ...
	 <option value="first_impression">first_impression</option>
...
if ($deno!=159 AND  $panel == 1 ){$sub=155-$deno;$deno=$deno+$sub;} else{$deno= $data[0];}
  ...
  echo "<script>console.log( 'Total: " . $deno . "' );</script>";
...
console.log("dashboard_tree2.php?centre=<?php echo $centre;?>&vichel_group=<?php echo $vichel_group;?>&age_group=<?php echo $age_group;?>&panel=<?php echo $panel;?>&age=<?php echo $age;?>&vechile_name=<?php echo $vechile_name;?>&intender=<?php echo $intender;?>&concept=<?php echo $concept;?>&table_name=<?php echo $table_name; ?>&mention=<?php echo $mention ;?>&vechile_code=<?php echo $vechile_code;?>&mention_no=<?php echo $mention_no;?>&vechicle_before=<?php echo $vechicle_before;?>&vechicle_after=<?php echo $vechicle_after; ?>&rank1=<?php echo $rank1; ?>&rank3=<?php echo $rank3 ;?>&rank2=<?php echo $rank2;?>&rank1_a=<?php echo $rank1_a;?><?php  
      echo '&analysis[]=' . 
       implode('&analysis[]=', array_map('urlencode', $analysis));?> ");
// load the external data

d3.csv("dashboard_tree2.php?centre=<?php echo $centre;?>&vichel_group=<?php echo $vichel_group;?>&age_group=<?php echo $age_group;?>&panel=<?php echo $panel;?>&age=<?php echo $age;?>&vechile_name=<?php echo $vechile_name;?>&intender=<?php echo $intender;?>&concept=<?php echo $concept;?>&table_name=<?php echo $table_name; ?>&mention=<?php echo $mention ;?>&vechile_code=<?php echo $vechile_code;?>&mention_no=<?php echo $mention_no;?>&vechicle_before=<?php echo $vechicle_before;?>&vechicle_after=<?php echo $vechicle_after; ?>&rank1=<?php echo $rank1; ?>&rank3=<?php echo $rank3 ;?>&rank2=<?php echo $rank2;?>&rank1_a=<?php echo $rank1_a;?><?php  
      echo '&analysis[]=' . 
