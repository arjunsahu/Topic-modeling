...
echo $table_name= $_POST["table_name"]?: 'exposed_final_shyam';
...
if ($mention==""){$mention_divide=4;}else{$mention_divide=1;}
...
<form method="post" action="">
  <div class="top  b-b" style="background-color:#F0F0F0">
   <div class="box" style=" margin-bottom: 0rem;">
		...
		<div class="row">
		    <div class="col-md-8">
          <h2>Section B - FeedBack On the II Vehicle Exposed</h2>
...
while($r = mysql_fetch_array($word)) {
	...
	<small class="label label-default label-as-badge ">Select Age</small>
              ...
              <div class="col-sm-10">
				...
				<option selected disabled>Select Age</option>
                  ...
                  <option value="2534">25-34</option>
                              ...
                              <option value="3445">34-45</option>
                </select>
              </div>
            </div>
			</div>
              ...
              <div class="col-sm-10">
                <select class="form-control c-select" name="intender">
                  ...
                  <option value="YAMAHA FASCINO">YAMAHA FASCINO</option>
                              ...
                              <option value="HONDA ACTIVA 4G">HONDA ACTIVA 4G</option>
							  
							  
							  
							     <option value="SUZUKI ACCESS 125">SUZUKI ACCESS 125</option>
                              <option value="APRILLIA SR150">APRILLIA SR150 </option>
                              <option value="HONDA DIO">HONDA DIO</option>
                              <option value="HONDA ACTIVA ">HONDA ACTIVA</option>
							  
							  
							  
							     <option value="PIAGGIO VESPA 15">PIAGGIO VESPA 15 </option>
                              <option value="PIAGAGIO VESPA 150">PIAGAGIO VESPA 150 </option>
                              <option value="YAMAHA RAY ZR">YAMAHA RAY ZR</option>
                              <option value="YAMAHA RAYZR">YAMAHA RAYZR</option>
							  
							     <option value="HERO MAESTRO EDGE">HERO MAESTRO EDGE</option>
                              <option value="HERO MAESTO EGDE">HERO MAESTO EGDE</option>
                </select>
              </div>
            </div>
			</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
			<small class="label label-default label-as-badge">Select pj</small>
			<div class="form-group row">
             
              <div class="col-sm-10">
                <select class="form-control c-select"  name="mention">
				
                  <option selected disabled>Select PJ</option>
				  <option value="">All</option>
		...
		<div class="form-group row">
			  ...
			  <small class="label label-default label-as-badge">Select exposed/ridden</small>
                <select class="form-control c-select" name="table_name" >
				  ...
				  <option value="">All</option>
                  <option value="exposed_final_shyam">exposed</option>
                  <option value="ridden_final">ridden</option>
                </select>
              </div>
            </div>	
			...
			<div class="col-sm-6">
			<small class="label label-default label-as-badge">type of Byer</small>	
			 ...
			 <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <select class="form-control c-select" name="vechile_name">
                  ...
                  <option selected disabled>type of Byer</option>
                  <option value="">ALL </option>
                   <?php 
...
while($r = mysql_fetch_array($word)) {
			...
			<!-- Section B -->
			<div class="col-md-12 text-center" style="padding-bottom: 15px;"> 
					<span  class="btn btn-sm btn-outline rounded b-accent">Section B </span> 
    ...
    <option value="problem_dislike">Aspects Disliked Problem</option>
			...
			<div class="col-sm-4">
			<small class="label label-default label-as-badge">Select vichel </small>	
            ...
            <div class="col-sm-10">
                <select class="form-control c-select"  name="concept">
                  ...
                  <option selected disabled>Select vichel</option>
				  <option value="">All</option>
				  <?php 
				$word = mysql_query("Select distinct(vichel_name) as vichel_name from  $table_name");

while($r = mysql_fetch_array($word)) {
	
                 echo" <option value='".$r["vichel_name"]."'>".$r["vichel_name"]."</option>";
}
				  ?>
	...
	<div class="form-inline">
            ...
            <div class="col-sm-10">
                <select class="form-control c-select"  name="vichel_group">
				
	
                  <option selected disabled>Select vichel</option>
				  <option value="">All</option>
				  <?php 
				$word = mysql_query("Select distinct(vichel_group) as vichel_group from  $table_name");

while($r = mysql_fetch_array($word)) {
	
                 echo" <option value='".$r["vichel_group"]."'>".$r["vichel_group"]."</option>";
}
				  ?>
...
from $table_name  GROUP BY serialno



");
$divide1 = sizeof($analysis);
if($divide1==1){$divide2=1;} else{$divide2=1;}
  echo "<script>console.log( 'SIZE OF Objects: " . $divide1 . "' );</script>";
 echo "<script>console.log( 'DIVIDE: " . $divide2 . "' );</script>";
...
$v1[8] = $rv1[8]/$divide2;
$v1[9] = $rv1[9]/$divide2;
$v1[10] = $rv1[10]/$divide2;
$v1[11] = $rv1[11]/$divide2;
$v1[12] = $rv1[12]/$divide2;
$v1[13] = $rv1[13]/$divide2;
$v1[14] = $rv1[14]/$divide2;
$v1[15] = $rv1[15]/$divide2;
$v1[16] = $rv1[16]/($divide2*2);
$v1[17] = $rv1[17]/$divide2;
$v1[18] = $rv1[18]/$divide2;
$v1[19] = $rv1[19]/$divide2;
$v1[20] = $rv1[20]/$divide2;
$v1[21] = $rv1[21]/$divide2;
$v1[22] = $rv1[22]/$divide2;
$v1[23] = $rv1[23]/$divide2;
$v1[24] = $rv1[24]/($divide2*3);
...
//echo"selectcount(case when (".implode($head_light," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and vichel_group  like '%".$vichel_group."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and vichel_name  like '%".$concept."%' and pj  like '%".$mention."%'then 1 end ) as head_light from exposed_final_shyam";

//echo"select count(case when  (".implode($head_light," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and vichel_group  like '%".$vichel_group."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and vichel_name  like '%".$concept."%' and pj  like '%".$mention."%'then 1 end ) as head_light from $table_name";

//echo "select count(distinct(serialno)) from $table_name  where occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and vichel_group  like '%".$vichel_group."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and vichel_name  like '%".$concept."%' and pj  like '%".$mention."%'";
