...
<form method="post" action="">
  <div class="top  b-b" style="background-color:#F0F0F0">
   <div class="box" style=" margin-bottom: 0rem;">
		...
		<div class="row">
		    <div class="col-md-8">
          <h2>Section BO5 - FeedBack On the Exposed Vehicle For  Not choosing Rank1 But Rank2 to   Rank11  </h2>
...
while($r = mysql_fetch_array($word)) {
			...
			<!-- Section B -->
			<div class="col-md-12 text-center" style="padding-bottom: 15px;"> 
					<span  class="btn btn-sm btn-outline rounded b-accent">Section BO5 </span> 
