...
//occupation like '%".$centre."%' and rank1  like '%".$rank1."%'   and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  $string and r_name  like '%".$concept."%' and pj  like '%".$mention."%'
...
echo $table_name= $_POST["table_name"]?: 'expo_savvy';
 $mention= $_POST["mention"]?: '';//PJ
if (preg_match('/Entor/',$concept)){$correct=2;}else {$correct=0;}
...
<form method="post" action="">
  <div class="top  b-b" style="background-color:#F0F0F0">
   <div class="box" style=" margin-bottom: 0rem;">
		...
		<div class="row">
		    <div class="col-md-8">
          <h2>Section B02 - FeedBack On the  Vehicle Exposed</h2>
          <small>Interviewer to code the vehicle to be Exposed.</small>
		   </div>
		     <div class="col-md-4">
		...
		<div class="form-group row">
			  ...
			  <small class="label label-default label-as-badge">Select exposed/ridden</small>
                <select class="form-control c-select" name="table_name" >
                  ...
                  <option value="ridden_soul_final">ridden</option>
                </select>
              </div>
            </div>	
...
while($r = mysql_fetch_array($word)) {
			...
			<!-- Section B -->
			<div class="col-md-12 text-center" style="padding-bottom: 15px;"> 
					<span  class="btn btn-sm btn-outline rounded b-accent">Section BO3 </span> 
     ...
     <option selected disabled>Select Vehicle</option>
				  <option value="">All</option>
				  <option value="Jupiter">TVS Jupiter</option> <option value="Aprillia">Aprillia SR 150</option> <option value="Dio">Honda Dio</option> <option value="Ray">Yamaha RayZR</option> <option value="Fascino">Yamaha Fascino</option> <option value="Piaggio Vespa 150">Piaggio Vespa 150</option> <option value="Entor">TVS Entor Q SXR 125</option> <option value="Honda Activa 125">Honda Activa 125</option> <option value="Access">Suzuki Access 125</option> <option value="Edge">Hero Maestro Edge</option> <option value="Honda Activa 4G">Honda Activa 4G</option> 
                </select>
              </div>
            </div>
			</div>
...
foreach ($ranks as $value) {  $cost[] = "$value REGEXP 'cost|price|money|rupee|expens|budg'  " ;}
foreach ($ranks as $value) {  $body[] = "$value REGEXP 'body|heav|wei'  " ;}
foreach ($ranks as $value) {  $brand[] = "$value REGEXP 'brand|compa'  " ;}

foreach ($ranks as $value) {  $tech[] = "$value REGEXP 'tech'  " ;}
foreach ($ranks as $value) {  $Suitable_for[] = "$value REGEXP ' men| man|young|Child|Lady|women|boy'  " ;}
foreach ($ranks as $value) {  $battery[] = "$value REGEXP 'batt|usb|charge'  " ;}
foreach ($ranks as $value) {  $bluetooth[] = "$value REGEXP 'bluet|blue t'  " ;}
//Nishank whole query Change
$v1_q = mysql_query("
select  count(DISTINCT serialno) from expo_savvy where (".implode($head_light," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  $string and r_name  like '%".$concept."%' and pj  like '%".$mention."%'
 union all 
...
union all 
select  count(DISTINCT serialno) from expo_savvy where (".implode($cost," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and  $string and r_name  like '%".$concept."%' and pj  like '%".$mention."%'
 union all 

select  count(DISTINCT serialno) from expo_savvy where (".implode($body," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and  $string and r_name  like '%".$concept."%' and pj  like '%".$mention."%'
 union all 

select  count(DISTINCT serialno) from expo_savvy where (".implode($brand," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and  $string and r_name  like '%".$concept."%' and pj  like '%".$mention."%'
 union all 

select  count(DISTINCT serialno) from expo_savvy where (".implode($tech," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and  $string and r_name  like '%".$concept."%' and pj  like '%".$mention."%'
 union all 
 
select  count(DISTINCT serialno) from expo_savvy where (".implode($Suitable_for," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and  $string and r_name  like '%".$concept."%' and pj  like '%".$mention."%'
 union all 
 
  
select  count(DISTINCT serialno) from expo_savvy where (".implode($battery," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and  $string and r_name  like '%".$concept."%' and pj  like '%".$mention."%'
 union all 
   
select  count(DISTINCT serialno) from expo_savvy where (".implode($bluetooth," OR ")." ) and  occupation like '%".$centre."%' and rank1  like '%".$rank1."%'  and ( rank2  like '%".$rank2."%' and  rank3  like '%".$rank3."%' ) and marital_status like '%".$age_group."%' and mention like '%".$mentio_no."%' and panel_no like '%".$panel."%' and age like '%".$age."%' and type_of_buyer like '%".$vechile_name."%' and brand_intended like '%".$intender."%' and  vichel like '%".$vechile_code."%' and  $string and r_name  like '%".$concept."%' and pj  like '%".$mention."%'
 union all 
...
");
  ...
  echo "<script>console.log( 'Co: " . $correct . "' );</script>";
