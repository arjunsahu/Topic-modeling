...
while($r = mysql_fetch_array($word)) {
	  ...
	  <option value="1">Ridden(BO4)</option>
	   <option value="2">exposed(BO2)</option>
	   <option value="3">Reason choosing Ranked 1(BO6)</option>
